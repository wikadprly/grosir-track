...
export default function UbahPinClient() {
  ...
  const canSubmit = currentPin && newPin.length === 6 && confirmPin.length === 6 && !isPending;
    ...
    <div className="space-y-5">
      <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 space-y-3">
        <div className="flex items-center gap-3">
          ...
          <p className="text-base font-bold text-gray-800">Ubah PIN Aplikasi</p>
        </div>
